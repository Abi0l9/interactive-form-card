...
const Card = ({ data }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center md:flex-col-reverse md:gap-y-5 py-5 w-full md:h-screen md:w-2/4 ">
      <div className="h-[60%] md:h-screen absolute top-0 left-0 -z-10 w-full md:w-2/6 bg-gradient-to-b md:bg-gradient-to-b from-pink-950 from-40% via-gray-800 to-slate-900"></div>
